...
{
    public partial class FormSalesOutbound : Form
    {
        DataBase db = new DataBase();
        CommonUse commUse = new CommonUse();

        public FormSalesOutbound()
        {
            InitializeComponent();
        ...
        private void FormSalesOutbound_Load(object sender, EventArgs e)
        {
            //Product
        ...
        private void ControlStatus()
        {
            ...
            this.textAddress.Enabled = !this.textAddress.Enabled;
        ...
        private void FillControls()
        {
            ...
            this.txtQuantity.Text = this.dgvPO[6, this.dgvPO.CurrentCell.RowIndex].Value.ToString();
            this.textAddress.Text = this.dgvPO[7, this.dgvPO.CurrentCell.RowIndex].Value.ToString();
        ...
        {
            SqlCommand Cmd = new SqlCommand("getSalesOutbound", db.Conn);
            ...
            try
            {
                ...
                {
                    Cmd.Parameters.AddWithValue("@SalesOutboundID", OrderID);
                ...
                SqlDataAdapter SalesOutbound = new SqlDataAdapter();
                DataTable PO = new DataTable();
                SalesOutbound.SelectCommand = Cmd;
                SalesOutbound.Fill(PO);
        ...
        private void toolDelete_Click(object sender, EventArgs e)
        {
            db.Conn.Open();
            int row;
            SqlCommand Cmd = new SqlCommand("deleteSalesOutbound", db.Conn);
            Cmd.CommandType = CommandType.StoredProcedure;
            Cmd.Parameters.AddWithValue("@SalesOutboundID", Convert.ToInt32(txtSalesOutID.Text));
        ...
        private void toolSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    SqlCommand Cmd = new SqlCommand("addSalesOutbound", db.Conn);
                    Cmd.CommandType = CommandType.StoredProcedure;
                ...
                {
                    SqlCommand Cmd = new SqlCommand("updateSalesOutbound", db.Conn);
                    Cmd.CommandType = CommandType.StoredProcedure;
                    Cmd.Parameters.AddWithValue("@SalesOutboundID", Convert.ToInt32(txtSalesOutID.Text));
